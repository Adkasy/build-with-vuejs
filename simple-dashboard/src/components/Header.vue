...
.navbar {
  height: 65px;
  position: fixed; /* Menggunakan position: fixed untuk mengatur posisi tetap pada bagian atas halaman */
  top: 0; /* Menggunakan top: 0 untuk memastikan navbar berada di bagian atas halaman */
